...
Spotify MCP Server
==================
One file. Drop it anywhere. Control Spotify with Claude.

SETUP (one time only):
1. pip install mcp spotipy
2. Fill in your SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET below
3. Add this file to your Claude Desktop config (see README)
4. python3 spotify_mcp_server.py --login
"""
